(function($) {
   ...
   $(document).on("click",".mejs-loop-button",function(evt){
	...
	//$(playerParentSelector).find("."+tracklistDomSelector).remove();
...
////////////////////////////BUILD PLAYLIST //////// 	 
   ...
   if(this.loopStatus == "single"){
	...
	///////////Append Play, This will append the object and play it 
	appendPlayItem : function(trackDataObj){
	
	//get the Appended Item Index 
    appendedItemIndex = this.appendItem(trackDataObj);
    
	//play it 
	this.playItemByIndex(appendedItemIndex);
	}//end append Play 
